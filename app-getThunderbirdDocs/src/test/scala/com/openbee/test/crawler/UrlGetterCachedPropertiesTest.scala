 ...
 */
class UrlGetterCachedPropertiesTest {
  val url_source = "http://yopyop:8080/monfichier.txt"
  ...
  def before {
    ...
    val httpGetter = new UrlGetterCachedProperties(data, simpleGetter)
  ...
  def testGetUrlWithFileCache() {
    ...
    val newHttpGetter = new UrlGetterCachedProperties(data, simpleGetter)
